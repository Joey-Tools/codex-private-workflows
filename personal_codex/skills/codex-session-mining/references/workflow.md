...
If Joey is asking for a work summary, activity audit, or session recovery that may include `miku-bot-dev`, `hoteng-srv-01`, or `codex-hoteng-srv-01`, use `$remote-host-context` before concluding that the local `~/.codex` tree is complete.
