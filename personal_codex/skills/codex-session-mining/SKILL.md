...
- It inventories active and archived rollouts, including legacy filenames whose lifecycle ID is available only in bounded `session_meta`, and applies bounded regular-file reads, inventory and turn caps, plus a shared best-effort deadline.
