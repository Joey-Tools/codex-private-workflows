...
python3 scripts/session_retrospective.py validate-history-commit --retained-run-dir .codex-local/session-retrospective/retained/20260522/daily --history-repo /path/to/codex-session-retrospective-history --history-commit <40-char-retained-export-commit-sha>
