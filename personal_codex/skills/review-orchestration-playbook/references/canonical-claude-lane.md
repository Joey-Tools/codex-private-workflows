...
Always run identity-bound workspace cleanup after the terminal result unless Joey explicitly requests retention. Keep raw stream evidence only in its parent-private bounded destination according to the task's retention needs.
