...
Cleanup is the default after success, findings, blocked, or inconclusive termination. Retain a workspace only when Joey explicitly requests diagnostic retention.
