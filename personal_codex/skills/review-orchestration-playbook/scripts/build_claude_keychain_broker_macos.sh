...
EXPECTED_HOSTED_CODESIGN_SHA256="844d30a12929b59c9f2215e2a308c3e1db572831a478f35906e452a54025603e"
EXPECTED_HOSTED_LEGACY_CODESIGN_SHA256="06eacc36d43376972d3bca0a2137ea4efd6d0fe27de8a7af0e6b11d599e8f337"
EXPECTED_HOSTED_OS_VERSION="26.6.2"
EXPECTED_HOSTED_OS_BUILD="25G83"
EXPECTED_HOSTED_PREVIOUS_OS_VERSION="26.5.2"
EXPECTED_HOSTED_PREVIOUS_OS_BUILD="25F84"
EXPECTED_HOSTED_PREVIOUS_CODESIGN_SHA256="214d455584d19abc0d74d02b9cbc7d3da6bdcb0596c235e6156dd9ed2f4e1ba7"
...
select_hosted_codesign_sha256() {
  ...
  case "$os_version:$os_build" in
    "$EXPECTED_HOSTED_OS_VERSION:$EXPECTED_HOSTED_OS_BUILD")
      ...
      ;;
    "$EXPECTED_HOSTED_PREVIOUS_OS_VERSION:$EXPECTED_HOSTED_PREVIOUS_OS_BUILD")
      printf '%s\n' "$EXPECTED_HOSTED_PREVIOUS_CODESIGN_SHA256"
      ;;
