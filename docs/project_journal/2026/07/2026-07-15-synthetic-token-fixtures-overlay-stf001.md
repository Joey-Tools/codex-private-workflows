...
- The regular-file overlay rejects unsafe paths, symlinks, hard links, missing or non-regular inputs and targets, oversized sources, unsafe ownership or permissions, duplicate outputs, and observed path or file-identity drift. It verifies the generated bytes before replacing the existing target.
