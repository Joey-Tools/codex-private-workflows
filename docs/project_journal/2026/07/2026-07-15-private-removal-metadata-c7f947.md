...
## Evidence
- Repository suite — 1038 tests were exercised with Python 3.13.0 after integrating the latest `origin/master`; 1032 passed and 2 skipped in the sandbox, while the 4 GPG-signed merge tests blocked by sandboxed keybox access all passed on a narrow host-access rerun.
