...
- Keep the budget split, fixed-`S0` coordinates, anchor behavior, append tolerance, partial-record handling, and later-user ordering covered by focused probe regressions.
